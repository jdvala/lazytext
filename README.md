...
## Installation
**Stable Release:** `pip install lazytext`<br>
**Development Head:** `pip install git+https://github.com/jdvala/lazytext.git`

## Documentation
For full package documentation please visit [jdvala.github.io/lazytext](https://jdvala.github.io/lazytext).
...
* Turn your project into a GitHub repository:
  ...
  * After a GitHub repo has been created, run the following commands:
    * `git remote add origin git@github.com:jdvala/lazytext.git`
    * `git push -u origin master`
* Register lazytext with Codecov:
  ...
  * Copy the token provided, go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/jdvala/lazytext/settings/secrets),
...
generation to work
  ...
  * Go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/jdvala/lazytext/settings/secrets),
...
* Add branch protections to `master` and `stable`
    * To protect from just anyone pushing to `master` or `stable` (the branches with
    ...
    configurations)
    * Go to your [GitHub repository's settings and under the `Branches` tab](https://github.com/jdvala/lazytext/settings/branches), click `Add rule` and select the
